...
class VocabComponent(customtkinter.CTkFrame):
    def __init__(self, master, **kwargs):
        ...
        self.buttonWords.place(relx = 0.4, rely = 0.5,anchor=tkinter.CENTER)
        ...
        self.button0.place(relx = 0.6, rely = 0.5,anchor=tkinter.CENTER)
    ...
    def button_click(self, butNum):
        if butNum == 0:
            if self.button0.cget("text") == self.answerDef:
                print("Correct")
            ...
            if self.button1.cget("text") == self.answerDef:
                print("Correct")
                self.configure(fg_color = "green")
            else:
                print("Incorrect")
            ...
            if self.button2.cget("text") == self.answerDef:
                print("Correct")
                self.configure(fg_color = "green")
            else:
                print("Incorrect")
            ...
            if self.button3.cget("text") == self.answerDef:
                print("Correct")
                self.configure(fg_color = "green")
            else:
                print("Incorrect")
    ...
    def load(self):
        self.prompt = customtkinter.CTkLabel(self, text = "Placeholder Text", font=("Times", 24, "bold"))
        ...
        self.button0.place(relx = 0.4, rely = 0.4,anchor=tkinter.CENTER)
        ...
        self.button1.place(relx = 0.6, rely = 0.4,anchor=tkinter.CENTER)
        ...
        self.button2.place(relx = 0.4, rely = 0.6,anchor=tkinter.CENTER)
        ...
        self.button3.place(relx = 0.6, rely = 0.6,anchor=tkinter.CENTER)

        self.buttonNext = customtkinter.CTkButton(self, command=self.button_next, text="Next")
        self.buttonNext.grid(row=3, column=1, padx=20, pady=20)
